...
- [Design](docs/DESIGN.md) — high-level architecture and file format specification
- [Scripting](docs/SCRIPTING.md) — research document on embedded scripting and programmability approaches
